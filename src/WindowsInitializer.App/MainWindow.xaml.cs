...
public partial class MainWindow : Wpf.Ui.Controls.FluentWindow
{
    ...
    private async void SelfTest_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            var stateRoot = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "WindowsInitializer", "state", "self-tests");
    ...
    private async void ExportRecoveryRollback_Click(object sender, RoutedEventArgs e)
    {
        ...
        var dialog = new SaveFileDialog
        {
            ...
            FileName = $"windows-initializer-rollback-{selected.RunId[..Math.Min(8, selected.RunId.Length)]}.reg",
            AddExtension = true,
            DefaultExt = ".reg"
        };
    ...
    private static string StateRoot() => Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "WindowsInitializer", "state");
    ...
    private async void Apply_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            {
                var uacStateRoot = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "WindowsInitializer", "state");
    ...
    private async void History_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            var root = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "WindowsInitializer", "state");
    ...
    private async void ExportDiagnostics_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            var dialog = new SaveFileDialog
            {
                ...
                FileName = $"windows-initializer-{latest.RunId}.diagnostics.json",
                AddExtension = true,
                DefaultExt = ".json"
            };
            if (dialog.ShowDialog(this) != true) return;
    ...
    private async void ExportPlanTemplate_Click(object sender, RoutedEventArgs e)
    {
        ...
        var templateDirectory = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "WindowsInitializer", "templates");
        Directory.CreateDirectory(templateDirectory);
        var dialog = new SaveFileDialog
        {
            Title = Localization.Get("exportPlanTemplate"),
            Filter = Localization.Get("planTemplateFilter"),
            FileName = $"windows-initializer-plan-{DateTime.Now:yyyyMMdd-HHmmss}.json",
    ...
    private async void ExportRegistryRollback_Click(object sender, RoutedEventArgs e)
    {
        var dialog = new SaveFileDialog
        {
            ...
            Filter = Localization.Get("registryFileFilter"),
            FileName = $"WindowsInitializer-registry-rollback-{DateTime.Now:yyyyMMdd-HHmmss}.reg"
        };
        if (dialog.ShowDialog(this) != true) return;
        try
        {
