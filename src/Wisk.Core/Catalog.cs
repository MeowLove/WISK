...
public sealed class Catalog
{
    ...
    [
        ...
        new("app-everything", "Everything Alpha", "Applications", RiskLevel.Elevated, TaskKind.Winget, RequiresAdministrator: true, RequiresInternet: true, PackageId: "voidtools.Everything.Alpha", PackageScope: "machine"),
        ...
        new("runtime-edge", "Microsoft Edge", "Browsers", RiskLevel.Standard, TaskKind.Winget, RequiresInternet: true, PackageId: "Microsoft.Edge", PackageScope: "machine"),
        new("runtime-webview2", "Microsoft Edge WebView2 Runtime", "Runtime", RiskLevel.Standard, TaskKind.Winget, RequiresInternet: true, PackageId: "Microsoft.EdgeWebView2Runtime", PackageScope: "machine"),
        ...
        new("app-vscode", "Visual Studio Code", "Development tools", RiskLevel.Standard, TaskKind.Winget, RequiresInternet: true, PackageId: "Microsoft.VisualStudioCode", PackageScope: "machine"),
        ...
        new("app-chocolatey", "Chocolatey", "Package managers", RiskLevel.Standard, TaskKind.Winget, RequiresInternet: true, PackageId: "Chocolatey.Chocolatey", PackageScope: "machine"),
        new("app-peazip", "PeaZip", "Utilities", RiskLevel.Standard, TaskKind.Winget, RequiresInternet: true, PackageId: "Giorgiotani.Peazip", PackageScope: "machine"),
        ...
        new("app-localsend", "LocalSend", "Networking", RiskLevel.Standard, TaskKind.Winget, RequiresInternet: true, PackageId: "LocalSend.LocalSend", PackageScope: "machine"),
        new("app-syncthing", "Syncthing", "Networking", RiskLevel.Standard, TaskKind.Winget, RequiresInternet: true, PackageId: "Syncthing.Syncthing", PackageScope: "machine"),
        new("app-syncthingtray", "Syncthing Tray", "Networking", RiskLevel.Standard, TaskKind.Winget, RequiresInternet: true, PackageId: "Martchus.syncthingtray", PackageScope: "machine"),
        new("app-obs", "OBS Studio", "Graphics and media", RiskLevel.Standard, TaskKind.Winget, RequiresInternet: true, PackageId: "OBSProject.OBSStudio", PackageScope: "machine"),
        new("app-advanced-ip-scanner", "Advanced IP Scanner", "Networking", RiskLevel.Standard, TaskKind.Winget, RequiresInternet: true, PackageId: "Famatech.AdvancedIPScanner", PackageScope: "machine"),
        new("app-wsl-manager", "WSL Manager", "Virtualization", RiskLevel.Standard, TaskKind.Winget, RequiresInternet: true, PackageId: "Bostrot.WSLManager", PackageScope: "machine",
        ...
        new("app-fxsound", "FxSound", "Graphics and media", RiskLevel.Standard, TaskKind.Winget, RequiresInternet: true, PackageId: "FxSound.FxSound", PackageScope: "machine"),
        new("app-escrcpy", "Escrcpy", "Mobile tools", RiskLevel.Standard, TaskKind.Winget, RequiresInternet: true, PackageId: "viarotel.Escrcpy", PackageScope: "machine"),
        new("app-nanabox", "NanaBox", "Virtualization", RiskLevel.Standard, TaskKind.Winget, RequiresInternet: true, PackageId: "9NJXJSCB2JK0"),
        new("app-docker-desktop", "Docker Desktop", "Virtualization", RiskLevel.Elevated, TaskKind.Winget, RequiresAdministrator: true, RequiresInternet: true, PackageId: "Docker.DockerDesktop", PackageScope: "machine",
        ...
        new("app-openvpn", "OpenVPN", "Networking", RiskLevel.Elevated, TaskKind.Winget, RequiresAdministrator: true, RequiresInternet: true, PackageId: "OpenVPNTechnologies.OpenVPN", PackageScope: "machine"),
        ...
        new("app-sandboxie-plus", "Sandboxie-Plus", "Security", RiskLevel.High, TaskKind.Winget, RequiresAdministrator: true, RequiresInternet: true, PackageId: "Sandboxie.Plus", PackageScope: "machine"),
