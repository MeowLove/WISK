...
public sealed partial class LocalizationTests
{
    ...
    {
        var source = File.ReadAllText(Path.Combine(RepositoryRoot(), "src", "WindowsInitializer.App", "Localization.cs"));
    ...
    public void EveryDeclarativeLocalizationKeyExists()
    {
        ...
        var appDirectory = Path.Combine(root, "src", "WindowsInitializer.App");
